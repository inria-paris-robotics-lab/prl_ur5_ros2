...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            "/world/workbench_world/model/dual_ur/link/base_link/sensor/bravo_camera_color/image@sensor_msgs/msg/Image[gz.msgs.Image",
            "/world/workbench_world/model/dual_ur/link/base_link/sensor/bravo_camera_color/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo",
            "/world/workbench_world/model/dual_ur/link/base_link/sensor/bravo_camera_depth/depth_image/points@sensor_msgs/msg/PointCloud2[gz.msgs.PointCloudPacked",
        ],
        output="screen",
        parameters=[{"use_sim_time": use_sim_time}],
    )
