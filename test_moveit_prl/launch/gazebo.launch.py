...
def generate_launch_description():
    ...
    controller_file=PathJoinSubstitution([FindPackageShare('test_moveit_prl'),'config', 'ros2_controllers.yaml'])
    ...
    #Config file
    moveit_config = (
        MoveItConfigsBuilder(robot_name="ur", package_name="test_moveit_prl")
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("test_moveit_prl"), "config", "moveit.rviz"]
    )
    ...
    moveit_controller = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            PathJoinSubstitution([
            FindPackageShare('test_moveit_prl'),
            'launch',
